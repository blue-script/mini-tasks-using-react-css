...
function Clock() {
    ...
    const stringTime = new Intl.DateTimeFormat('ru', {timeStyle: 'medium'}).format(date) // getCurrentTime(date) // || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
